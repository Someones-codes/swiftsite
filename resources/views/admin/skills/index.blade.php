            ...
            <form action="{{ route('admin.skills.store') }}" method="POST">
                ...
                <div class="form-group">
                    <label class="form-label">
                        Proficiency:
                        <span id="profVal" style="color:var(--navy2);font-weight:700;">
                            {{ old('proficiency', 80) }}%
                        </span>
                    </label>
                ...
                <div class="form-group">
                    ...
                    <div class="form-hint">Lower number = appears first in its category</div>
                </div>
    ...
    <div style="display:flex;flex-direction:column;gap:16px;">
        ...
        <div class="card">
            <div class="card-body" style="text-align:center;padding:48px;color:var(--gray);">
                ...
                <p>No skills added yet. Use the form to add your first skill.</p>
            </div>
        </div>
        @endif
