...
<style>
    ...
    * {
    ...
    .portfolio-nav {
        ...
        align-items: center;
        z-index: 1000;
        box-shadow: 0 2px 15px rgba(40, 114, 161, 0.1);
    }
    ...
    @media (max-width: 768px) {
        ...
        .nav-links {
            ...
            padding: 8px;
            border-radius: 14px;
            box-shadow: 0 12px 30px rgba(40, 114, 161, 0.18);
        }
    ...
    <div class="projects-grid">
        ...
        <div class="project-card">
            ...
            <div class="project-body">
                ...
                <a href="{{ route('demo.finance.index') }}" class="project-cta">→ View Live Demo</a>
            </div>
        </div>
        ...
        <div class="project-card">
            ...
            <div class="project-body">
                ...
                <a href="{{ route('demo.water.index') }}" class="project-cta">→ View Live Demo</a>
            </div>
        </div>
        ...
        <div class="project-card">
            ...
            <div class="project-body">
                ...
                <a href="{{ route('demo.blog.index') }}" class="project-cta">→ View Live Demo</a>
            </div>
        </div>
